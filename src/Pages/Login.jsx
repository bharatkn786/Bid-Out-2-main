      ...
      <div className="lg:flex">
        <div className="lg:w-1/2 xl:max-w-screen-sm">
          ...
          <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-1 xl:px-24 xl:max-w-2xl">
            <h2
              className="text-center text-4xl text-pink-900 font-display font-semibold lg:text-left xl:text-5xl
                    xl:text-bold"
            >
              Log in
            </h2>
            <div className="mt-12">
              <form onSubmit={onSubmit}>
                <div>
                  <div className="text-sm font-bold text-gray-700 tracking-wide px-4 py-2">
                    Email Address
                  </div>
                  <input
                    className="w-full text-lg border-b border-gray-300 focus:outline-none focus:border-pink-500 rounded-full py-4 px-4"
                    id="email"
                    type="email"
                    value={email}
                    onChange={onChange}
                ...
                <div className="mt-8">
                  <div className="flex justify-between items-center px-4 py-2">
                    ...
                    <div>
                      <Link to="/forgetpassword"
                        className="text-xs font-display font-semibold text-pink-600 hover:text-pink-800
                                        cursor-pointer"
                      >
                        Forgot Password?
                      </Link>
                  ...
                  <div className="relative flex w-full">
                    <input
                      className="w-full text-lg py-4 px-4 border-b border-gray-300 focus:outline-none focus:border-pink-500 rounded-full"
                      id="password"
                ...
                <div className="mt-10">
                  <button
                    className="bg-pink-500 text-gray-100 p-4 w-full rounded-full tracking-wide
                ...
                <div className="mt-5 w-full text-center">OR</div>
                <Link to="/signup" className="mt-5">
                  <div
                    className="bg-green-500 text-gray-100 p-2 w-full rounded-full tracking-wide
                                font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-white border border-transparent transition-all hover:border-green-500 hover:text-green-500
