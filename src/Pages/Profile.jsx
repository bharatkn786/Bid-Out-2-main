        ...
        <div class="bg-white rounded-lg shadow-xl pb-8">
          ...
          />}
            <div class="flex items-center space-x-2 mt-2">
              <p class="text-2xl">{auth.currentUser.displayName}</p>
          ...
          <div class="flex-1 flex flex-col items-center lg:items-end justify-end px-8 mt-2">
            <div class="flex items-center space-x-4 mt-2">
              <a href="mailto:bidout2024@gmail.com" class="flex items-center bg-blue-600 hover:bg-green-700 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-4 w-4"
                  viewBox="0 0 20 20"
              ...
              <a  href="pages/front-account.html"class="flex items-center bg-blue-600 hover:bg-green-700 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-4 w-4"
                  viewBox="0 0 20 20"
                ...
                <span className="text-xs xs:text-sm">Continue to Homepage</span>
              </a>
              <button onClick={()=>{auth.signOut()
                navigate("/")}} class="flex items-center bg-pink-600 hover:bg-red-700 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-4 w-4"
                  viewBox="0 0 20 20"
